...
A Java project built for the Object Oriented Concept (OOC) course. The project simulates an arm robot control system and demonstrates OOP concepts taught in Weeks 1 to 5.
...
```
ARM ROBOT CONTROL SYSTEM -- WEEKS 1 TO 5
